...
def encode_data(
    ...
    for col_index in range(D):
        ...
        if use_bert_masking:
            # Here you add a column which designates 
            # whether the feature at stake has been masked or not
            # and then you replace the missing entries by a zero everywhere
            # and specify that they are masked.
