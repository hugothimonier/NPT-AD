...
rm -rf ./data/arrhythmia/arrhythmia/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/arrhythmia
mkdir -p ./results/arrhythmia
...
python -u run.py \
    ...
    --exp_name arrhythmia_params \
    --np_seed 1 \
    --torch_seed 1 \
    --original_torch_seed 1 \
    --n_runs 20 \
    --exp_batch_size -1 \
    --exp_val_batchsize 259 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/arrhythmia/$Q_DATE.log