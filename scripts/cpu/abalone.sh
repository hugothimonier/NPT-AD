...
rm -rf ./data/abalone/abalone/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/abalone
mkdir -p ./results/abalone

python -u run.py --n_runs 20 \
    --data_path ./data/abalone/ \
    --data_set abalone \
    --res_dir job_$Q_DATE \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name abalone_default \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/abalone/$Q_DATE.log