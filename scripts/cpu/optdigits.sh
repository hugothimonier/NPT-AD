...
rm -rf ./data/optdigits/optdigits/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/optdigits
mkdir -p ./results/optdigits

python -u run.py \
    --n_runs 20 \
    --project NPT-AD \
    --data_path ./data/optdigits/ \
    --data_set optdigits \
    --res_dir job_29_03_2023__15_33_25_seed_1 \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name optdigits_params \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --model_dim_hidden 16 \
    --model_augmentation_bert_mask_prob "dict(train=0.2, val=0.25, test=0.15)" \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/optdigits/$Q_DATE.log