...
python -u  run.py \
    ...
    --exp_name backdoor_exp \
    --np_seed 1 \
    --torch_seed 1 \
    --original_torch_seed 1 \
    --exp_batch_size 256 \
    --exp_val_batchsize 128 \
    --exp_num_train_inference 128 \
    --exp_num_total_steps 186000 \
    ...
    --model_dim_hidden 32 \
    --model_augmentation_bert_mask_prob "dict(train=0.2, val=0.2, test=0.1)" \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/backdoor/$Q_DATE.log