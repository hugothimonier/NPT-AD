...
rm -rf ./data/pima/pima/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/pima
mkdir -p ./results/pima

python -u run.py \
    --n_runs 20 \
    --data_path ./data/pima/ \
    --data_set pima \
    --res_dir job_31_03_2023__17_25_39_seed_1 \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name pima_params \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/pima/$Q_DATE.log