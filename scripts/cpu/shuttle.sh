...
python -u run.py \
    ...
    --exp_num_train_inference 3696 \
    --exp_num_total_steps 1300 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/shuttle/$Q_DATE.log