...
rm -rf ./data/annthyroid/annthyroid/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/annthyroid
mkdir -p ./results/annthyroid

python -u run.py --n_runs 20 \
    --data_path ./data/annthyroid/ \
    --data_set annthyroid \
    --res_dir job_$Q_DATE \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name annthyroid_default \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --exp_num_total_steps 400 \
    --exp_eval_every_n 400 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/annthyroid/$Q_DATE.log