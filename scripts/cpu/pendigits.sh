...
rm -rf ./data/pendigits/pendigits/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/pendigits
mkdir -p ./results/pendigits

python -u run.py \
    --n_runs 20 \
    --project NPT-AD \
    --data_path ./data/pendigits/ \
    --data_set pendigits \
    --res_dir job_06_04_2023__15_02_50_seed_1 \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name pendigits_params \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/pendigits/$Q_DATE.log