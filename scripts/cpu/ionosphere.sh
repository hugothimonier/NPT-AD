...
rm -rf ./data/ionosphere/ionosphere/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/ionosphere
mkdir -p ./results/ionosphere

python -u run.py \
    --n_runs 20 \
    --data_path ./data/ionosphere/ \
    --data_set ionosphere \
    --res_dir job_$Q_DATE \
    --data_loader_nprocs 0 \
    --data_set_on_cuda False \
    --exp_name ionosphere_params \
    --np_seed 1 \
    --torch_seed 1 \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/ionosphere/$Q_DATE.log