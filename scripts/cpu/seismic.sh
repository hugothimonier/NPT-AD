...
rm -rf ./data/seismic/seismic/*
export Q_DATE=$(date "+%d_%m_%y_%H_%M") 
mkdir -p ./logs/seismic
mkdir -p ./results/seismic
...
python -u run.py \
    ...
    --model_rff_depth 1 \
    --ad True \
    --data_force_reload True > ./logs/seismic/$Q_DATE.log
